...
function TitleBar({ onOpen, theme, toggleTheme }) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-left", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "titlebar-menu", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onOpen, children: "Открыть" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { children: "Настройки" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { children: "О программе" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "titlebar-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "theme-toggle", onClick: toggleTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `toggle-switch ${theme}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-brightness-high" }),
...
function App() {
  ...
  const [selectedPreset, setSelectedPreset] = reactExports.useState(PRESETS[0]);
  ...
  reactExports.useEffect(() => {
    if (filePaths.length > 0) {
      const loadData = async () => {
        try {
          const data = await window.api.getVideoData(filePaths);
          setVideos(data.map((v2) => ({ ...v2, progress: 0, status: "ready" })));
          setView("list");
        } catch (err) {
  ...
  reactExports.useEffect(() => {
    window.api.onCliProgress(({ id: id2, progress }) => {
      setVideos((prev) => prev.map((v2) => v2.id === id2 ? { ...v2, progress, status: "encoding" } : v2));
    });
    window.api.onCliExit(({ id: id2, code, outputPath }) => {
      setVideos((prev) => prev.map((v2) => v2.id === id2 ? { ...v2, progress: 100, status: code === 0 ? "done" : "error" } : v2));
      setVideos((current) => {
        const stillEncoding = current.some((v2) => v2.status === "encoding");
        if (!stillEncoding) setIsEncoding(false);
        return current;
      });
    });
  }, []);
  ...
  const startEncoding = () => {
    setIsEncoding(true);
    videos.forEach((v2) => {
      window.api.runCli({ filePath: v2.path, preset: selectedPreset, id: v2.id });
    });
  };
  const renderContent = () => {
    if (view === "list") {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-list-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-list-header-row", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "preset-selector", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "ENCODING PRESET" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "select",
            {
              ...
              disabled: isEncoding,
              children: PRESETS.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: p2, children: p2 }, p2))
            }
          )
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-list-scroll", children: videos.map((v2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `video-item ${v2.status} ${theme}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-info", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-meta", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-info-circle" }),
              " ",
              v2.meta
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-progress-container", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar-bg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "progress-bar-fill", style: { width: `${v2.progress}%` } }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "video-size", children: v2.status === "done" ? /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-check-circle-fill success" }) : v2.size })
        ] }, v2.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "video-list-footer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "footer-label", children: isEncoding ? "PROCESSING BATCH..." : "READY TO START" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              className: `next-button ${isEncoding ? "disabled" : ""}`,
              onClick: startEncoding,
              disabled: isEncoding,
              children: [
                isEncoding ? "ENCODING..." : "START ENCODING",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `bi ${isEncoding ? "bi-hourglass-split" : "bi-play-fill"}` })
              ]
            }
          )
        ] })
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "drop-content", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "drop-icon-large", children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "bi bi-upload" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "drop-text-large", children: "Add file / files" })
          ] }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `app-wrapper ${theme}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(TitleBar, { onOpen: handleSelectFiles, theme, toggleTheme }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container", children: renderContent() })
  ] });
}
