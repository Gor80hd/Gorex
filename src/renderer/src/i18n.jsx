...
const TRANSLATIONS = {
    ru: {
        ...
        whatsNewDownloadTitle: 'Улучшенный интерфейс',
        whatsNewDownloadText: 'Интерфейс стал аккуратнее и понятнее: обновлены очередь, действия с файлами и навигация по настройкам.',
        whatsNewAudioTitle: 'Конвертация видео в аудио',
        whatsNewAudioText: 'Теперь можно конвертировать видео в аудио и сохранять звук в MP3, M4A, FLAC, Opus, OGG или WAV.',
        whatsNewQueueTitle: 'Понятнее готовые задачи',
        whatsNewQueueText: 'У завершённых файлов появилась кнопка открытия папки прямо в очереди.',
        whatsNewAuthTitle: 'Beta: вход YouTube через Google',
        whatsNewAuthText: 'Бета-функция: можно войти в Google/YouTube, чтобы скачивать ролики, которым нужна авторизация.',
        whatsNewUpdatesTitle: 'Автообновление библиотек',
        whatsNewUpdatesText: 'Gorex проверяет обновления yt-dlp, показывает статус библиотек и помогает обновить их прямо из настроек.',
    ...
    en: {
        ...
        whatsNewDownloadTitle: 'Improved interface',
        whatsNewDownloadText: 'The interface is cleaner and easier to read, with updated queue actions, file controls and settings navigation.',
        whatsNewAudioTitle: 'Video to audio conversion',
        whatsNewAudioText: 'You can now convert video into audio and save sound as MP3, M4A, FLAC, Opus, OGG or WAV.',
        whatsNewQueueTitle: 'Cleaner completed queue',
        whatsNewQueueText: 'Finished tasks now show an open-folder action right where the file is.',
        whatsNewAuthTitle: 'Beta: YouTube Google sign-in',
        whatsNewAuthText: 'Beta feature: sign in to Google/YouTube to download videos that require authorization.',
        whatsNewUpdatesTitle: 'Automatic library updates',
        whatsNewUpdatesText: 'Gorex checks yt-dlp updates, shows library status and helps update them from settings.',
